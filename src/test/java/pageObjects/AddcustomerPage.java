...
public class AddcustomerPage {
	...
	By lnkCustomers_menuitem=By.xpath("//a[@href='/Admin/Customer/List']//*[@class='nav-icon far fa-dot-circle']");
	...
	By txtNewsLetters=By.xpath("(//div[@class='k-multiselect-wrap k-floatwrap'])[1]");
